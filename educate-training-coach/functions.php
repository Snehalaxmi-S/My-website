...
function educate_training_coach_customize_register() {
  ...
  $wp_customize->remove_section( 'education_insight_middle_section' );
...
function educate_training_coach_remove_my_action() {
    remove_action( 'admin_menu','education_insight_gettingstarted' );
    remove_action( 'after_setup_theme','education_insight_notice' );
}
add_action( 'init', 'educate_training_coach_remove_my_action');
...
if ( ! defined( 'EDUCATE_TRAINING_COACH_PRO_LINK' ) ) {
  define('EDUCATE_TRAINING_COACH_PRO_LINK',__('https://www.ovationthemes.com/wordpress/training-coach-wordpress-theme/','educate-training-coach'));
}
